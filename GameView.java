...
import group7.tcss450.uw.edu.centipedeandroid.game.system.SpiderMovementSystem;
...
public class GameView extends SurfaceView implements Runnable {
    ...
    private MetaEntity mCentBody;

    private MetaEntity mScorpian;
    ...
    public void createLevel() {
        ...
        mCentBody = EntityFactory.createCentipede(this, 10);

        //testing!
        Random rand = new Random();
        int y = rand.nextInt(800) + 300;
        mScorpian = EntityFactory.createScorpian(this, 0, y);
        ...
        mOrderedSubSystems.add(new SpiderMovementSystem(this));
